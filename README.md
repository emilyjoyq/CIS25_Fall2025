...
- string name = jewelry item's name
- int quantity = how many of that item are in stock
- saveToFile() = saves item to a file (items.txt)
- loadFromFile() = reads and displays all items from the file
